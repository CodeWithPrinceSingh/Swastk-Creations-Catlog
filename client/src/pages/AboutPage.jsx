...
export default function AboutPage() {
  return (
    <StaticPage title="About Us">
      ...
      <p>
        From hand-embroidered lehengas to heirloom-inspired jewellery, every piece in our
        collection is curated with India's bridal traditions at heart — designed for the modern
        bride who wants to honour where she comes from while stepping into her own happily ever
        after.
      </p>
      <p>
