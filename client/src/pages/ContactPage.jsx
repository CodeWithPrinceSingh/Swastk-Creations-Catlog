      ...
      <div className="grid lg:grid-cols-2 gap-12">
        <div>
          ...
          <div className="space-y-4 text-sm">
            ...
            <p className="flex items-center gap-3"><Clock size={16} className="text-rose-500" /> Mon - Sat: 10AM - 10
...
PM</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-rose-600 hover:bg-rose-700 transition-colors text-white font-semibold text-sm tracking-wide py-3 rounded-md"
          >
            SEND MESSAGE
          </button>
